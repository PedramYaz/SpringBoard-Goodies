...
SELECT category FROM analytics GROUP BY categroy HAVING COUNT(*) > 300;
...
SELECT app_name, reviews, min_stalls, min_installs / reviews AS proportion FROM analytics WHERE min_installs >= 100000 ORDER BY proportion DESC LIMIT 1;